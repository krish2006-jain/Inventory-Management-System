...
function Settings() {
  const actions = (
    <>
      <button className="subtle-btn" type="button">Reset Changes</button>
      ...
      <section className="settings-grid">
        <article className="panel-surface settings-card settings-main-card">
          ...
          <div className="settings-form-grid">
            <label className="settings-field" htmlFor="business-name">
              Business Name
              <input id="business-name" type="text" defaultValue="Stockly Ventures" />
            </label>
            <label className="settings-field" htmlFor="business-email">
              Contact Email
              <input id="business-email" type="email" defaultValue="ops@stockly.com" />
            </label>
            <label className="settings-field" htmlFor="business-phone">
              Phone
              <input id="business-phone" type="text" defaultValue="+91 98765 43210" />
            </label>
            <label className="settings-field" htmlFor="business-address">
              Address
              <input id="business-address" type="text" defaultValue="18 Market Street, Mumbai" />
            </label>
          </div>
        </article>
        ...
        <article className="panel-surface settings-card">
          ...
          <div className="settings-security-list">
            <button type="button" className="text-chip">Change Password</button>
            <button type="button" className="text-chip">Enable 2FA</button>
            <button type="button" className="text-chip">Session Timeout: 30 min</button>
          </div>
        </article>
        ...
        <article className="panel-surface settings-card">
          <h4>Regional</h4>
          <div className="settings-security-list">
            <button type="button" className="text-chip">Currency: INR (₹)</button>
            <button type="button" className="text-chip">Timezone: IST (UTC+5:30)</button>
            <button type="button" className="text-chip">Date format: DD/MM/YYYY</button>
          </div>
        </article>
      </section>
    </WorkspaceLayout>
